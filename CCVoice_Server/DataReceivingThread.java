    ...
    public void run() {
        try {
            ...
            for (int i = 0; i < totalFileCount; i++) {
                ...
                String filePath = "/home/gill/customer_list/" + id + "/" + fileName + "wav";
        ...
        try {
            ...
            for (SpeechRecognitionResult result: results) {
                ...
                try {
                    ...
                    File file = new File("/home/gill/customer_list/" + id + "/" + file_name + "txt");
...
/*
recognitionSpeech(filePath, id, file_name) {

	INPUT : AudioSound
	OUTPUT : ConvertTextFile
	
	TextFiles save in filePath;
